...
public class CaseTestCPE0305 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			...
			driver.findElement(lastNameLocator).sendKeys("Do");
			
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("Por favor revisa el campo apellidos, minimo de caracteres 3."));
		} 
	}
