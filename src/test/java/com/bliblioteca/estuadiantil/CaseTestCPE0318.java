...
public class CaseTestCPE0318 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			...
			driver.findElement(passLocator).sendKeys("contraseña12345678910");
			
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("Por favor revisa el campo contraseña, maximo de caracteres 20."));
		} 
	}
