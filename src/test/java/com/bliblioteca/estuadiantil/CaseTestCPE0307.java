...
public class CaseTestCPE0307 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			...
			driver.findElement(lastNameLocator).sendKeys("Lopez1Paz");
			
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("Por favor revisa el campo apellidos, ingresar solo caracteres alfabéticos."));
		} 
	}
