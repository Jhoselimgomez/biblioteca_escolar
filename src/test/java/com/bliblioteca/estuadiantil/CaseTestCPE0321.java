...
public class CaseTestCPE0321 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			...
			driver.findElement(passLocator).sendKeys("!Contraseña123");
			
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("El registro ha sido exitoso"));
		} 
	}
