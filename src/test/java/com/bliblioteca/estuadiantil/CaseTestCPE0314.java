...
public class CaseTestCPE0314 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			...
			driver.findElement(phoneLocator).sendKeys("123456789111214");
			
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("Por favor revisa el campo teléfono, máximo de caracteres 12."));
		} 
	}
