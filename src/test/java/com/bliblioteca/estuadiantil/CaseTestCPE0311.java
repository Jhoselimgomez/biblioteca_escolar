...
public class CaseTestCPE0311 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			...
			driver.findElement(emailLocator).sendKeys("daniellopez.com");
			
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("Por favor revisa el campo correo, dirección de correo invalida (name@ejemplo.com)."));
		} 
	}
