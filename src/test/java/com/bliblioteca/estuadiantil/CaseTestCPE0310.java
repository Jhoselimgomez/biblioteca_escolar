...
public class CaseTestCPE0310 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			...
			driver.findElement(emailLocator).sendKeys("daniellopez@gmail.com.co");
			
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("Por favor revisa el campo correo, minimo de caracteres 3."));
		} 
	}
