...
public class CaseTestCPE0306 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			...
			driver.findElement(lastNameLocator).sendKeys("Ballesteros");
			
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("Por favor revisa el campo apellidos, máximo de caracteres 10."));
		} 
	}
