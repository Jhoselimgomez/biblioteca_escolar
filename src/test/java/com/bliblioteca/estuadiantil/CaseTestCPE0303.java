...
public class CaseTestCPE0303 {
	...
	public void test() {
		...
		if(driver.findElement(registroTextLocator).isDisplayed()) {
			driver.findElement(userNameLocator).sendKeys("Leon1David");
			driver.findElement(btnRegisterLocator).click();
			
			assertTrue(driver.findElement(alertRegisterLocator).getText().contains("Por favor revisa el campo nombre, ingresar solo caracteres alfabéticos"));
		} 
	}
