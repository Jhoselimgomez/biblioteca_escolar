...
public class CaseTestCPE0403 {
	...
	public void test() {
		...
		if(driver.findElement(loginTextLocator).isDisplayed()) {
			driver.findElement(emailLocator).sendKeys("manuel@gmail.com");
			driver.findElement(passLocator).sendKeys("1234");
			
			driver.findElement(btnLoguinLocator).click();
			
			assertTrue(driver.findElement(alertLocator).getText().contains("El email o contraseña no son correctos, intenta de nuevo."));
		} 
	}
